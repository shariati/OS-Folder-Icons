             ...
             <div>
              ...
              <div className="relative mb-2">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                  value={post.coverImage || ''}
                  onChange={(e) => onChange({ ...post, coverImage: e.target.value })}
                />
              </div>
              {post.coverImage && (
                <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 aspect-video relative">
