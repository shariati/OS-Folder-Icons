...
export function checkRateLimit(
    ...
    const options = typeof endpointType === 'string'
    ...
    if (entry.count > options.maxRequests) {
        ...
        logger.warn({ clientId, path: request.nextUrl.pathname, count: entry.count }, 'Rate limit exceeded');
 ...
 */
export function withRateLimit<T extends (...args: [NextRequest, ...any[]]) => Promise<NextResponse>>(
    handler: T,
